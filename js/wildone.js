...
/*
  ...
  4. owl carousel
	...
	4.3. owl news carousel - SPECIAL EDITION
  5. magnificPopup
  6. navigation
  ...
  12. section position reset
    12.1. news position reset
	12.2. contact position reset
*/
...
$(function() {
	...
	// 4.3. owl news carousel - SPECIAL EDITION
    $("#news-page-img-carousel-SPECIAL-EDITION").owlCarousel({
        loop: true,
        center: true,
        items: 1,
        margin: 0,
